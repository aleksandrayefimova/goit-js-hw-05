...
const getTotalBalanceByGender = (users, gender) => {
  ...
  // const filteredClients = users.filter(client => client.gender === gender)
  
  // const total = filteredClients.reduce((acc, client) => {
  //    return acc += client.balance
  // }, 0)

return users.filter(client => client.gender === gender).reduce((acc, client) => {
  return acc += client.balance
}, 0)
